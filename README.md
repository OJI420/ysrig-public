...
## セットアップ手順
**ysrig-public**をダウンロード。  

**YSRig**フォルダ と **userSetup.mel** を **ドキュメント/maya/2024/scripts** 直下へ移動。  
