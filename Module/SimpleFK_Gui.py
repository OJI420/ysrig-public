...
class Gui(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.dropdown00.addItems(self.data.get("FK"))
        ...
        label3 = QtWidgets.QLabel("Controller Shape :")
        label3.setAlignment(QtCore.Qt.AlignRight)
        self.dropdown = QtWidgets.QComboBox()
        self.dropdown.addItems(["cube", "circle", "shoulder", "square", "sphere"])
        main_layout.addWidget(label3, 3, 0)
        main_layout.addWidget(self.dropdown, 3, 1, 1, 2)
        ...
        main_layout.addWidget(self.scale_field, 4, 1, 1, 2)

        frame1 = QtWidgets.QFrame()
        frame1.setFrameShape(QtWidgets.QFrame.HLine)
        frame1.setFrameShadow(QtWidgets.QFrame.Sunken)

        main_layout.addWidget(frame1, 5, 0, 1, 3)
        ...
        main_layout.addWidget(label5, 6, 0)
        main_layout.addWidget(self.radio1, 6, 1)
        main_layout.addWidget(self.radio2, 6, 2)

        label6 = QtWidgets.QLabel("Insert Space Node :")
        label6.setAlignment(QtCore.Qt.AlignRight)
        self.checkbox = QtWidgets.QCheckBox()
        main_layout.addWidget(label6, 7, 0)
        main_layout.addWidget(self.checkbox, 7, 1)
        ...
        main_layout.addWidget(self.button, 8, 0, 1, 3)
    ...
    def call(self):
        ...
        SimpleFK.main(part, jt_list, [search, replace], shape=shape, scale=scale, cnnect=type, space=space)
...
def show_Gui():
    ...
    for widget in QtWidgets.QApplication.allWidgets():
        if widget.objectName() == "YSSimpleFK_Gui":
            widget.close()
