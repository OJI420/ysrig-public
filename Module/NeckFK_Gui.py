...
class Gui(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.dropdown00.addItems(self.data.get("Neck"))
        ...
        self.dropdown.addItems(["circle", "cube", "square"])
        ...
        main_layout.addWidget(self.button, 7, 0, 1, 3)
    ...
    def call(self):
        ...
        NeckFK.main(part, jt_list, [search, replace], shape=shape, scale=scale, cnnect=type)
...
def show_Gui():
    ...
    for widget in QtWidgets.QApplication.allWidgets():
        if widget.objectName() == "YSNeckFK_Gui":
            widget.close()
