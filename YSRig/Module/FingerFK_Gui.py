...
class Gui(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.dropdown00.addItems(self.data.get("Finger"))
        ...
        self.dropdown.addItems(["cube", "circle", "square"])
        ...
        main_layout.addWidget(self.dropdown2, 7, 1, 1, 2)
    ...
    def call(self):
        ...
        type = "World"
        all_axis = self.dropdown2.currentText()
        ...
        FingerFK.main(part, jt_list, [search, replace], shape=shape, scale=scale, cnnect=type, all_axis=all_axis)
...
def show_Gui():
    ...
    for widget in QtWidgets.QApplication.allWidgets():
        if widget.objectName() == "YSFingerFK_Gui":
            widget.close()
